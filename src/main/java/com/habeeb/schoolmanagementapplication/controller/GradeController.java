...
public class GradeController {
    ...
    @PutMapping("update/grade/student/{studentId}/course/{courseId}")
    ...
    @GetMapping("get/grade/student/{studentId}/course/{courseId}")
    ...
    @DeleteMapping("delete/grade/student/{studentId}/course/{courseId}")
